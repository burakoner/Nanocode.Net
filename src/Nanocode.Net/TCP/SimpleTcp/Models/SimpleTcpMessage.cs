...
namespace Nanocode.Net.TCP.SimpleTcp.Client
{
    public class SimpleTcpMessage
    {
        private TcpClient _tcpClient;
        private System.Text.Encoding _encoder = null;
        private byte _writeLineDelimiter;
        private bool _autoTrim = false;
        internal SimpleTcpMessage(byte[] data, TcpClient tcpClient, System.Text.Encoding stringEncoder, byte lineDelimiter)
        {
            Data = data;
        ...
        internal SimpleTcpMessage(byte[] data, TcpClient tcpClient, System.Text.Encoding stringEncoder, byte lineDelimiter, bool autoTrim)
        {
            Data = data;
            _tcpClient = tcpClient;
            _encoder = stringEncoder;
