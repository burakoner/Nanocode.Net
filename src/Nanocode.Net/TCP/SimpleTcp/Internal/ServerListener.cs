...
namespace Nanocode.Net.TCP.SimpleTcp.Internal
{
    internal class ServerListener
    {
        ...
        internal ServerListener(SimpleTcpServer parentServer, IPAddress ipAddress, int port)
        {
            ...
            _listener = new TcpListenerExtended(ipAddress, port);
            _listener.Start();
        ...
        internal TcpListenerExtended Listener { get { return _listener; } }
